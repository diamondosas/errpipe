...
func StreamToChan(errorMessage string, outChan chan<- string, errChan chan<- error) {
	...
	req.Header.Set("x-vqd-hash-1", "")
	...
	if resp.StatusCode != 200 {
		...
		errChan <- fmt.Errorf("chat API returned %d: %s", resp.StatusCode, string(bodyBytes))
		return
	}
